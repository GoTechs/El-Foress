...
<div class="col-sm-9 page-content">
  <div class="inner-box">
    <div class="usearadmin">
      <h3><a href="#"><img class="userimg" src="{{asset('img/picto-user.png')}}" alt="" loading="lazy" />
          {{Auth::user()->nom}}</a></h3>
    </div>
  </div>
  <div class="inner-box">
    <div class="welcome-msg">
      ...
      <span class="page-sub-header-sub small">
        <!--Dernier accès au Web le: 01-03-2017 à 02:55 PM--></span>
      @endif
    ...
    <div id="accordion" class="panel-group">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title"> <a href="#collapseB1" data-toggle="collapse">
              {{__('home_profil.home_page_title')}}</a> </h4>
        </div>
      ...
      <div class="panel panel-default" id="error">
        <div class="panel-heading">
          @if ($errors->any())
          <h4 class="panel-title"> <a href="#collapseB2" data-toggle="collapse"> {{__('home_profil.setting_title')}}
            </a> </h4>
        </div>
        <div class="panel-collapse collapse in" id="collapseB2">
          @else
          <h4 class="panel-title"> <a aria-expanded="false" class="collapsed" href="#collapseB2" data-toggle="collapse">
              Changer le mot de passe</a> </h4>
        </div>
          ...
          <div class="panel-body">
            <form role="form" method="post" action="/updatePassword/{{Auth::user()->id}}">
              ...
              <div class="form-group {{ $errors->has('currentpassword') ? ' has-error' : '' }} has-feedback">
                ...
                <input class="form-control" placeholder="" name="currentpassword" type="password"
