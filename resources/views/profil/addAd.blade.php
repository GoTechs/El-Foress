      ...
      <div class="col-sm-9">
          ...
          <form class="search-form" enctype="multipart/form-data" method="post" action="javascript:void(0)" id="addAd">
            ...
            <div class="form-group has-feedback Caterror">
              ...
              <select class="form-control" id="categorie" name="categorie">
                ...
                <option @if(old('categorie')==$value->idCat) {{ 'selected' }} @endif
                  value="{{$value->idCat}}">{{ $value->categories }}</option>
                @endforeach
              </select>
        ...
        <div class="box">
          <div class="form-group mb30 has-feedback titlerror">
            ...
            <input class="form-control input-md" name="Adtitle" id="Adtitle"
              placeholder="Écrivez un titre approprié pour votre annonce" type="text" value="{{old('Adtitle')}}">
          ...
          <div class="form-group state">
            ...
            <select class="form-control" name="etat" id="etat">
              <option value="">Sélectionner</option>
              <option {{ old('etat') == 'Produit neuf jamais utilisé' ? 'selected' : ''}}>Produit neuf jamais utilisé
              </option>
              <option {{ old('etat') == 'État neuf (Sous emballage)' ? 'selected' : ''}}>État neuf (Sous emballage)
              </option>
          ...
          <div class="form-group mb30 has-feedback descerror">
            <label class="control-label">Description <span class="required">*</span></label> <textarea
              class="form-control" rows="5" name="descrp" id="descrp">{{old('descrp')}}</textarea>
        ...
        <div class="box details" id="vehicule">
          ...
          <div class="form-group">
            <label class="control-label" for="textarea">Modèle</label> <input class="form-control" name="modeleVeh"
              id="modeleVeh" type="text">
          </div>
          <div class="form-group">
            <label class="control-label" for="textarea">Année</label> <input class="form-control" name="anneVeh"
              id="anneVeh" type="text">
          </div>
          <div class="form-group">
            <label class="control-label" for="textarea">Kilomètrage</label> <input class="form-control" name="kilomVeh"
              id="kilomVeh" type="text">
          </div>
          <div class="form-group">
        ...
        <div class="box details" id="phone">
          ...
          <div class="form-group">
            <label class="control-label" for="textarea">Modèle</label> <input class="form-control" name="modelePhone"
              id="modelePhone" type="text">
          </div>
        </div>
        ...
        <div class="box details" id="ordinateurs">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="tailleDisque" id="tailleDisque" type="text"
              value="{{old('tailleDisque')}}">
          </div>
        </div>
        ...
        <div class="box details" id="offresEmploi">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="diplomeRequis" id="diplomeRequis" type="text"
              value="{{old('diplomeRequis')}}">
          </div>
        </div>
        ...
        <div class="box">
          ...
          <div class="form-group has-feedback wilayaerror">
            ...
            <input class="form-control dropdown-product selectpicker" name="wilaya" id="wilaya2" placeholder="Wilaya"
              value="{{old('wilaya')}}">
          ...
          <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }} has-feedback">
            ...
            <div class="checkbox">
              <label>
                ...
                <input type="checkbox" value="1" name="phoneHide" id="phoneHide1"> <small>Masquer le numéro de téléphone
        ...
        <div class="form-group">
          <div class="page-ads box">
            <div class="checkbox has-feedback">
              <label>
                <input type="checkbox" name="condition">En affichant cette annonce, vous acceptez nos <a
                  class="btn-link" href="/centre-aide/conditions-d-utilisation" target="_blank">Conditions
                  d’utilisation</a>
                  , notre <a class="btn-link" href="/centre-aide/politique-de-confidentialite" target="_blank">Politique
                  de confidentialité </a>
                et nos
                <a class="btn-link" href="/centre-aide/regles-d-affichage" target="_blank">Règles d’affichage</a>.
              </label>
