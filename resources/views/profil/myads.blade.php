          ...
          <div class="adds-wrapper">
            ...
            <div class="item-list filter" id="{{$result->id_annonce}}">
              ...
              <div class="col-sm-3 text-right  price-box">
                ...
                <a class="btn btn-primary btn-sm" href="/update-AD/{{$result->id_annonce}}/edit"> <i
                    class="fa fa-pencil-square-o"></i> {{__('myads.update_button')}}</a>
                <a class="btn btn-info btn-sm" onclick="namespaceActions.archiveAd({{$result->id_annonce}})"> <i
                    class="fa fa-share-square-o"></i> {{__('myads.archived_button')}}</a>
                <a class="btn btn-danger btn-sm" onclick="namespaceActions.deleteAd({{$result->id_annonce}})"> <i
                    class=" fa fa-trash"></i> {{__('myads.delete_button')}}</a>
              </div>
            </div>
            @endforeach
          </div>
