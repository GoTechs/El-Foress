          ...
          <div class="table-action">
            <div class="checkbox">
              <label for="checkAll">
                ...
                {{__('myads.select_all_button')}} | <button type="button" class="btn btn-danger btn-sm" id="deleteAds">
          ...
          <div class="adds-wrapper">
            ...
            <div class="item-list filter" id="{{$result->id_annonce}}">
              ...
              <div class="col-sm-3 text-right  price-box">
                ...
                <a class="btn btn-danger btn-sm" onclick="namespaceActions.deleteFav({{$result->id_annonce}})"> <i
