          ...
          <form class="login-form" method="post" action="/admin/inscription">
            ...
            <div class="form-group {{ $errors->has('nom') ? ' has-error' : '' }} has-feedback">
              <div class="input-icon">
                ...
                <input type="text" id="nom" class="form-control" name="nom"
                  placeholder="{{__('authentication.last_name_input')}}" value="{{old('nom')}}">
              </div>
              @error('nom')
            ...
            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }} has-feedback">
              <div class="input-icon">
                ...
                <input id="email" class="form-control" name="email" placeholder="{{__('authentication.email_input')}}"
                  value="{{old('email')}}">
              </div>
              @error('email')
              <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="form-group {{ $errors->has('confirmPassword') ? ' has-error' : '' }} has-feedback">
              <div class="input-icon">
                ...
                <input type="password" id="confirmPassword" name="confirmPassword" class="form-control"
                  placeholder="{{__('authentication.confirm_password_input')}}" value="{{old('confirmPassword')}}">
              </div>
            ...
            <button class="btn btn-common log-btn" type="submit"
              name="addMember">{{__('authentication.register_submit_button')}}</button>
          </form>
          <ul class="form-links">
